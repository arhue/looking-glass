...
final class LookingGlass {
  ...
  public function render() {
	...
	print('<link rel="icon" type="image/png" sizes="196x196" href="/favicon-192.png">');
	print('<link rel="icon" type="image/png" sizes="160x160" href="/favicon-160.png">');
	print('<link rel="icon" type="image/png" sizes="96x96" href="/favicon-96.png">');
	print('<link rel="icon" type="image/png" sizes="64x64" href="/favicon-64.png">');
	print('<link rel="icon" type="image/png" sizes="32x32" href="/favicon-32.png">');
	print('<link rel="icon" type="image/png" sizes="16x16" href="/favicon-16.png">');
	print('<link rel="apple-touch-icon" href="/favicon-57.png">');
	print('<link rel="apple-touch-icon" sizes="114x114" href="/favicon-114.png">');
	print('<link rel="apple-touch-icon" sizes="72x72" href="/favicon-72.png">');
	print('<link rel="apple-touch-icon" sizes="144x144" href="/favicon-144.png">');
	print('<link rel="apple-touch-icon" sizes="60x60" href="/favicon-60.png">');
	print('<link rel="apple-touch-icon" sizes="120x120" href="/favicon-120.png">');
	print('<link rel="apple-touch-icon" sizes="76x76" href="/favicon-76.png">');
	print('<link rel="apple-touch-icon" sizes="152x152" href="/favicon-152.png">');
	print('<link rel="apple-touch-icon" sizes="180x180" href="/favicon-180.png">');
	print('<meta name="msapplication-TileColor" content="#FFFFFF">');
	print('<meta name="msapplication-TileImage" content="/favicon-144.png">');
	print('<meta name="msapplication-config" content="/browserconfig.xml">');
